...
- **WebSocket 出力**
  - `EventRealtimeOutput`, `EventRTCSignal`, `EventSpeechStart`, `EventSpeechEnd`, `EventRTCVADStatus`, `EventWhiteboardUpdate`, `EventSessionReset`, `EventAgentSpeechPlaybackEnd` をブラウザ向け JSON に変換する。
